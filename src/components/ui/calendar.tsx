    ...
    <div className="flex items-center justify-between w-full pt-1 px-1">
      <button
        ...
        className={cn(
          ...
          'size-7 bg-transparent p-0 opacity-50 hover:opacity-100 disabled:opacity-25'
        )}
      >
        <ChevronLeft className="size-4" />
      </button>
      <span className="text-sm font-medium">
        {formatters.formatMonthCaption(calendarMonth.date, { locale: dayPickerProps.locale })}
      </span>
      <button
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: 'flex items-center pt-1 w-full',
