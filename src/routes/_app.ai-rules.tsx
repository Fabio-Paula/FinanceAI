    ...
    <div className="p-6 space-y-5 max-w-4xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            Ensine a IA a categorizar automaticamente por padrões de texto
          </p>
        </div>
      ...
      <div className="flex items-start gap-3 p-4 rounded-lg border border-accent/20 bg-accent/5 text-sm">
        ...
        <p className="text-muted-foreground">
          Regras com maior <strong className="text-foreground">prioridade</strong> são aplicadas
          primeiro. A IA usa essas regras antes do modelo de linguagem, garantindo consistência nas
          categorizações.
        </p>
      </div>
