...
async function main() {
  ...
  const txDefs: TxDef[] = [
    ...
    {
      date: '2026-05-05',
      description: 'Salário maio/2026 - Empresa XPTO',
      amount: '8500.00',
    ...
    {
      date: '2026-05-05',
      description: 'Vale Refeição maio/2026',
      amount: '880.00',
      type: TransactionType.income,
      category: 'Salário',
      is_recurring: true,
    ...
    {
      date: '2026-05-10',
      description: 'Pagamento freelance - site landing page',
      amount: '2200.00',
      type: TransactionType.income,
      category: 'Freelance',
      tags: ['cliente', 'web'],
    ...
    {
      date: '2026-05-15',
      description: 'Dividendos FII KNRI11',
      amount: '342.50',
      type: TransactionType.income,
    ...
    {
      date: '2026-05-20',
      description: 'Rendimento CDB Nubank',
      amount: '185.30',
      type: TransactionType.income,
      category: 'Investimentos',
      tags: ['cdb', 'renda-fixa'],
    ...
    {
      date: '2026-05-22',
      description: 'Freelance - consultoria SEO',
      amount: '900.00',
      type: TransactionType.income,
      category: 'Freelance',
      tags: ['consultoria'],
    ...
    {
      date: '2026-05-28',
      description: 'Cashback cartão Nubank',
      amount: '47.80',
      type: TransactionType.income,
      category: 'Outros',
      tags: ['cashback'],
    ...
    {
      date: '2026-05-01',
      description: 'Aluguel apartamento maio',
      amount: '2100.00',
    ...
    {
      date: '2026-05-08',
      description: 'Conta de luz - Enel maio',
      amount: '187.40',
      type: TransactionType.expense,
      category: 'Moradia',
      is_recurring: true,
      tags: ['energia', 'utilidade'],
    },
    {
      date: '2026-05-10',
    ...
    {
      date: '2026-05-12',
      description: 'Internet fibra 500MB - Vivo',
      amount: '119.90',
      type: TransactionType.expense,
      category: 'Moradia',
      is_recurring: true,
    ...
    {
      date: '2026-05-15',
      description: 'Gás de cozinha - Ultragaz',
      amount: '135.00',
      type: TransactionType.expense,
      category: 'Moradia',
      tags: ['gás'],
    ...
    {
      date: '2026-05-07',
      description: 'iFood - Pizza Sábado',
      amount: '89.90',
      type: TransactionType.expense,
      category: 'Alimentação',
    ...
    {
      date: '2026-05-09',
      description: 'Padaria Boulangerie - café da manhã',
      amount: '28.50',
      type: TransactionType.expense,
      category: 'Alimentação',
      tags: ['café'],
    ...
    {
      date: '2026-05-16',
      description: 'Restaurante japonês Sakura',
      amount: '124.00',
      type: TransactionType.expense,
      category: 'Alimentação',
      tags: ['restaurante', 'jantar'],
    },
    {
      date: '2026-05-19',
      description: 'iFood - Hambúrguer Madero',
      amount: '67.40',
      type: TransactionType.expense,
      category: 'Alimentação',
      tags: ['delivery'],
    },
    {
      ...
      type: TransactionType.expense,
      category: 'Alimentação',
      tags: ['hortifruti', 'saudável'],
    },
    {
      date: '2026-05-26',
      description: 'Supermercado Mercadona compra semanal',
      amount: '253.60',
      type: TransactionType.expense,
      category: 'Alimentação',
      tags: ['mercado'],
    ...
    {
      date: '2026-05-29',
      description: 'Bar do Zé - happy hour',
      amount: '94.00',
      type: TransactionType.expense,
      category: 'Alimentação',
      tags: ['bar', 'lazer'],
    ...
    {
      date: '2026-05-03',
      description: 'Uber - trajeto trabalho',
      amount: '34.70',
      type: TransactionType.expense,
      category: 'Transporte',
      tags: ['uber', 'trabalho'],
    ...
    {
      date: '2026-05-17',
      description: 'Uber - ida ao aeroporto',
      amount: '78.90',
      type: TransactionType.expense,
      category: 'Transporte',
      tags: ['uber', 'viagem'],
    ...
    {
      date: '2026-05-24',
      description: 'Estacionamento Shopping Ibirapuera',
      amount: '42.00',
      type: TransactionType.expense,
      category: 'Transporte',
      tags: ['estacionamento'],
    ...
    {
      date: '2026-05-03',
      description: 'Plano de saúde Amil maio',
      amount: '680.00',
      type: TransactionType.expense,
      category: 'Saúde',
      is_recurring: true,
      tags: ['plano-saúde', 'fixo'],
    },
    {
      date: '2026-05-13',
      description: 'Farmácia Drogasil - medicamentos',
      amount: '143.60',
      type: TransactionType.expense,
      category: 'Saúde',
      tags: ['remédio', 'farmácia'],
    },
    {
      date: '2026-05-20',
      description: 'Consulta médica dermatologista',
      amount: '350.00',
      type: TransactionType.expense,
      category: 'Saúde',
      tags: ['consulta', 'médico'],
    },
    {
      date: '2026-05-27',
      description: 'Academia Smart Fit - mensalidade',
      amount: '109.90',
      type: TransactionType.expense,
      category: 'Saúde',
      is_recurring: true,
      tags: ['academia', 'exercício', 'fixo'],
    },

    // ── EDUCAÇÃO ──────────────────────────────────────────────────────────────
    {
      date: '2026-05-05',
      description: 'Curso Udemy - React Advanced',
      amount: '47.90',
      type: TransactionType.expense,
      category: 'Educação',
      tags: ['curso', 'programação', 'online'],
    },
    {
      date: '2026-05-15',
      description: 'Livro Clean Architecture - Amazon',
      amount: '89.90',
      type: TransactionType.expense,
      category: 'Educação',
      tags: ['livro', 'desenvolvimento'],
    },
    {
      date: '2026-05-20',
      ...
      category: 'Educação',
      is_recurring: true,
      tags: ['alura', 'programação', 'fixo'],
    },

    // ── ASSINATURAS ───────────────────────────────────────────────────────────
    {
      date: '2026-05-01',
      description: 'Netflix - plano premium',
      amount: '55.90',
      type: TransactionType.expense,
    ...
    {
      date: '2026-05-01',
      description: 'ChatGPT Plus - OpenAI',
      amount: '100.00',
      type: TransactionType.expense,
      category: 'Assinaturas',
      is_recurring: true,
    ...
    {
      date: '2026-05-10',
      description: 'Cinema Cinemark - 2 ingressos',
      amount: '78.00',
      type: TransactionType.expense,
      category: 'Lazer',
      tags: ['cinema', 'lazer'],
    ...
    {
      date: '2026-05-17',
      description: 'Ingresso show Coldplay - Allianz Parque',
      amount: '450.00',
      type: TransactionType.expense,
      category: 'Lazer',
      tags: ['show', 'música', 'evento'],
    },
    {
      date: '2026-05-24',
      description: "Steam - jogo Baldur's Gate 3",
      amount: '149.90',
      type: TransactionType.expense,
      category: 'Lazer',
      tags: ['jogo', 'steam'],
    ...
    {
      date: '2026-05-31',
      description: 'Passeio de barco Angra dos Reis',
      amount: '320.00',
      type: TransactionType.expense,
      category: 'Lazer',
      tags: ['viagem', 'passeio'],
    ...
    {
      date: '2026-05-18',
      description: 'Zara - camisas e calças',
      amount: '389.80',
      type: TransactionType.expense,
      category: 'Vestuário',
      tags: ['roupa', 'zara'],
    ...
    {
      date: '2026-05-25',
      description: 'Nike Store - tênis running',
      amount: '649.90',
      type: TransactionType.expense,
      category: 'Vestuário',
      tags: ['tênis', 'esporte'],
    ...
    {
      date: '2026-05-04',
      description: 'Presente aniversário - amigo',
      amount: '120.00',
      type: TransactionType.expense,
      category: 'Outros',
      tags: ['presente', 'social'],
    },
    {
      date: '2026-05-23',
      description: 'Petshop - ração Golden Retriever',
      amount: '215.00',
      type: TransactionType.expense,
      category: 'Outros',
      tags: ['pet', 'animal'],
